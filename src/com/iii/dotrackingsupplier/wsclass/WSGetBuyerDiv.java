...
public class WSGetBuyerDiv extends AsyncTask<Void, Void, ArrayList<String>> {
	// ------------------default floor1-----------------------------//
		...
		public WSGetBuyerDiv(Context mContext, String rd_date, String rd_time, ArrayList<String> lstDoNo
				, Spinner spnDoNo) {
			super();
			context = mContext;
		...
		protected ArrayList<String> doInBackground(Void... params) {
			...
			try {
				// ---------------get String ------------------------//
				String UrlGetDataDo = ConfigurationServer.getURLServer() + "wsgetBuyerDiv.php";
				...
				for (int i = 0; i < jarr.length(); i++) {
					...
					lstDoNo.add(element.getString("BUYER_DIVISION"));
				}
			} catch (Exception e) {
			}
