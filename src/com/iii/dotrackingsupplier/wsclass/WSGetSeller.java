...
public class WSGetSeller extends AsyncTask<Void, Void, ArrayList<String>> {
	// ------------------default floor1-----------------------------//
		...
		public WSGetSeller(Context mContext, String rd_date, String rd_time, ArrayList<String> lstDoNo
				, Spinner spnDoNo) {
			super();
			context = mContext;
		...
		protected ArrayList<String> doInBackground(Void... params) {
			...
			try {
				// ---------------get String ------------------------//
				String UrlGetDataDo = ConfigurationServer.getURLServer() + "wsgetSeller.php";
				...
				for (int i = 0; i < jarr.length(); i++) {
					...
					lstDoNo.add(element.getString("SELLER_COMPANY"));
					Log.d(">>>DO_NO", element.getString("SELLER_COMPANY"));
				}
			} catch (Exception e) {
			}
